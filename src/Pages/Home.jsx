...
export default function Home(){
    ...
    return(
        ...
        <Card style={{width: '300px'}}>
            <Card.Img style = {{width: '300px'}} src="/public/assets/pexels-kobeboy-1516440.jpg"></Card.Img>
            <Card.Body>
        ...
        <Col xs={12} md={4} className="d-flex justify-content-center mb-4">
        <Card style={{width: '300px'}}>
            <Card.Img style = {{width: '300px'}} src="/public/assets/pexels-buro-millennial-636760-1438072.jpg"></Card.Img>
            <Card.Body>
        ...
        <Col xs={12} md={4} className="d-flex justify-content-center mb-4">
        <Card style={{width: '300px'}}>
            <Card.Img style = {{width: '300px'}} src="/public/assets/pexels-olly-3762800.jpg"></Card.Img>
            <Card.Body>
