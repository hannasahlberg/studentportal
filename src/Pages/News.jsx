        ...
        <Row className="justify-content-center">
          <Col md={3}>
            <Card className="mb-5 mx-auto" style={{ width: "300px" }}>
              <Card.Img src="/public/assets/pexels-olly-3769021 (1).jpg" />
              <Card.Body>
            ...
            <Card className="mb-5 mx-auto" style={{ width: "300px" }}>
              <Card.Img src="/public/assets/pexels-vantha-thang-1224068-2513993.jpg" />
              <Card.Body>
            ...
            <Card className="mb-5 mx-auto" style={{ width: "300px" }}>
              <Card.Img src="/public/assets/pexels-sevenstormphotography-439391.jpg" />
              <Card.Body>
